using BAOMINH_SOLUTION_WEB_API.Config;
...
using QuanLyBanDoAnNhanh.Extensions;
using QuanLyBanDoAnNhanh.RepoContracts;
using QuanLyBanDoAnNhanh.Repository;
using System;
using System.IO;
...
namespace QuanLyBanDoAnNhanh
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IQuanTriRepository, QuanTriRepository>();
            services.AddScoped<ILoginRepository, LoginRepository>();
            services.AddScoped<ITrangChuRepository, TrangChuRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "QuanLyBanDoAnNhanh", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "QuanLyBanDoAnNhanh v1"));
            }
